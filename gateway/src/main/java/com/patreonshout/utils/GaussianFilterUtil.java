 ...
 * @author <a href="http://www.jhlabs.com/ip/blurring.html">Author link</a>
 */
public class GaussianFilterUtil extends ConvolveFilter {
	 ...
	 */
	public GaussianFilterUtil(float radius) {
		setRadius(radius);
	}
